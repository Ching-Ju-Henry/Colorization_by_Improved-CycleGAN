...
class cyclegan(object):
    ...
    def train(self, args):
        ...
        self.d_optim = tf.train.AdamOptimizer(self.lr, beta1=args.beta1,beta2=0.9) \
            .minimize(self.d_loss, var_list=self.d_vars)
        self.g_optim = tf.train.AdamOptimizer(self.lr, beta1=args.beta1,beta2=0.9) \
    ...
    def load(self, checkpoint_dir):
        ...
        print ckpt
        self.saver.restore(self.sess, '/media/VSlab3/howard/henry/CycleGAN-tensorflow/checkpoint/movie_data_256/cyclegan.model-52002')
